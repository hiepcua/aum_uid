	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" id="txt_code" name="txt_code" class="form-control required" value="" placeholder="Mã phòng ban">
			</div>
			<div class="form-group">
				<label>Tên phòng ban </label><font color="red">(*)</font>
				<input type="text" id="txt_name" name="txt_name" class="form-control required" value="" placeholder="Tên phòng ban">
			</div>
		</div>
	</div>
